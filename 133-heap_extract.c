...
/**
 * heap_extract - Retrieves a Max Binary Heap's root node..
 *
 * @root: A dual pointer to the heap's root node.
 *
 * Return: The value kept in the root node.
 */
...
/**
 * recurse_extract - Finds the maximum value in the tree repeatedly.
 *
 * @tree: The reference to the tree's root.
 */
